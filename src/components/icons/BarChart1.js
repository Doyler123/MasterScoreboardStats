...
let BarChart1Icon = (props) => (
  <SvgIcon viewBox="0 0 500 500" style={{margin : 0}} {...props}>
...
BarChart1Icon.displayName = 'BarChart1Icon';
BarChart1Icon.muiName = 'SvgIcon';
export default BarChart1Icon;